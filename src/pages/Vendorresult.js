...
function Vendorresult() {
  ...
  const servicesData = {
    ...
    HealthAndFitness: ["Fitness Trainer", "Nutritionist", "Gym Services", "Carers", "Nurse"],
    ...
    RealEstate: ["House Agent", "House Developer", "House Manager", "Architect", "House Packing Mover"],
