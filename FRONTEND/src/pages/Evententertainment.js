...
function Evententertainment() {
    const [selectedService, setSelectedService] = useState(null);
    const [vendors, setVendors] = useState([]);
  
    const services = ["Social Media Services", "Brand Influencer", "Ushering Event Services", "DJ Services", "Comendian Services", "Event Planning", "Party Souvenir Services", "Photography", "Cinematography", "Bouncers", "Party Rental Services"];
...
export default Evententertainment